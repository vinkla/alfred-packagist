# alfred-packagist [![Build Status](https://badgen.net/github/checks/vinkla/alfred-packagist?label=build&icon=github)](https://github.com/vinkla/alfred-packagist/actions)
